...
const questionPools = {
    jungle: [
        { id: "j1", question: "What is the largest land animal?", answer: "elephant" },
        { id: "j2", question: "Which bird is known for its beautiful tail feathers?", answer: "peacock" },
        { id: "j3", question: "What is the fastest animal on land?", answer: "cheetah" },
        { id: "j4", question: "Which mammal can fly?", answer: "bat" },
        { id: "j5", question: "What type of reptile is a crocodile?", answer: "reptile" },
    ],
    city: [
        { id: "c1", question: "What city is famous for the Eiffel Tower?", answer: "paris" },
        { id: "c2", question: "In which city would you find the Colosseum?", answer: "rome" },
        { id: "c3", question: "What city is known as 'The Big Apple'?", answer: "new york" },
        { id: "c4", question: "The Statue of Liberty is in which city's harbor?", answer: "new york" },
        { id: "c5", question: "Which city is home to the famous Big Ben clock tower?", answer: "london" },
    ]
};
...
wss.on("connection", (ws) => {
    ...
    ws.on("message", (message) => {
        ...
        if (data.method === "find_game") {
            ...
            if (!gameType || !questionPools[gameType]) {
            ...
            if (availableGame) {
                ...
                const gameId = guid();
                console.log(`No available ${gameType} games. Creating new game ${gameId} for player ${clientId}.`);
                games[gameId] = {
                    id: gameId,
                    gameType: gameType,
        ...
        if (data.method === "play") {
            ...
            setTimeout(() => {
                ...
                const questionSet = shuffleArray([...questionPools[game.gameType]]).slice(0, QUESTIONS_PER_TURN);
    ...
    ws.on("close", () => {
        ...
        if (gameToEnd) {
            ...
            const gameOverPayload = {
                ...
                gameType: gameToEnd.gameType // Send the game type on game over
            };
